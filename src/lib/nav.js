// Information architecture per frontend plan §7. Primary destinations feed
// the mobile rail (max five); secondary ones live inside workspaces.
...
export const ROLE_NAV_MORE = {
  ...
  evaluator: [
    { href: '/evaluator/evaluate', label: 'Evaluation Form' },
